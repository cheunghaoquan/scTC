...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_file', default='./data/mouse_ES_cell.h5')
    ...
    parser.add_argument('--save_dir', default='results/scTC_mouse_ES/',
                        help='directory to save model weights during the training stage')
    parser.add_argument('--ae_weight_file', default='AE_weights_mouse_ES.pth.tar',
                        help='file name to save model weights after the pretraining stage')
    parser.add_argument('--final_latent_file', default='final_latent_file_mouse_ES.txt',
                        help='file name to save final latent representations')
    parser.add_argument('--predict_label_file', default='pred_labels_mouse_ES.txt',
