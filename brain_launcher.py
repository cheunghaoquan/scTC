...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', default='results/scTC_brain/',
                        help='directory to save model weights during the training stage')
    parser.add_argument('--ae_weight_file', default='AE_weights_brain.pth.tar',
                        help='file name to save model weights after the pretraining stage')
    parser.add_argument('--final_latent_file', default='final_latent_file_brain.txt',
                        help='file name to save final latent representations')
    parser.add_argument('--predict_label_file', default='pred_labels_brain.txt',
    ...
    x = pd.read_csv("./data/brain.csv",header= None)
    x = np.array(x)
    y = pd.read_csv("./data/brain_label.csv",header= None)
